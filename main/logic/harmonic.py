...
# def get_trans(data: HarmonicModel, transaction_list: list):
#     transaction_data = {"INDEX": data.id,
#                         'TIME': data.time,
#                         'PAIR': data.pair,
#                         'POSITION': data.position,
...
#     monthly_data = {'month': month[0], 'transactions': transaction_list}
#     monthly_list.append(monthly_data)
#     transactions = HarmonicModel.get_transaction_by_pair(year=year, month=month[0], pair=pair[0])
#
...
#     pair_data = {'pair': pair[0], 'months': monthly_list}
#     pair_list.append(pair_data)
#     months = HarmonicModel.get_distinct_months_by_pair(year=year[0], pair=pair[0][0])
#
...
#     pair_list = []
#     yearly_data = {'year': year[0], 'pairs': pair_list}
#     pairs = HarmonicModel.get_distinct_pairs_by_year(year=year[0][0])
